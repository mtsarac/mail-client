...
- `MAILCLIENT_TEST_GREENMAIL=1` — GreenMail testlerini etkinleştirir. Varsayılan container dışında `MAILCLIENT_TEST_GREENMAIL_HOST`, `..._IMAP` (3143), `..._USER` (`test@localhost`), `..._PASSWORD` (`test123`) değerlerini geçersiz kılın.
