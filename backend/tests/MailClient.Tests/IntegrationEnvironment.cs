...
internal static class IntegrationEnvironment
{
    ...
    public static int GreenMailSmtpPort => Port("MAILCLIENT_TEST_GREENMAIL_SMTP", 3025);
    ...
    public static string GreenMailPassword => Value("MAILCLIENT_TEST_GREENMAIL_PASSWORD") ?? "test123@localhost";
